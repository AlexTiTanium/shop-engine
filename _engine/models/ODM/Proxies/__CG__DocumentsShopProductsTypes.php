 ...
 */
class ProductsTypes extends \Documents\Shop\ProductsTypes implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'nodeId', 'name', 'type', 'index', 'property');
    }
