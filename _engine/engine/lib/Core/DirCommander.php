...
use lib\Core\DirCommander\IDirCommanderAdapter;
use lib\Core\DirCommander\Exceptions\DirCommanderException;
...
class DirCommander {
   ...
   * @throws DirCommanderException
   * @return DirCommander
   * @throws DirCommander\Exceptions\DirCommanderException
   */
  public function up(){
